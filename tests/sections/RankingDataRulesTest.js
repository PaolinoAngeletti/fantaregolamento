    ...
    describe("RankingDataRules", function () {
        describe("produce", function () {
            it("should generate correct ranking explanation text", function () {
                ...
                expect(result).toContain("<p>10.1. La classifica verrà calcolata in base al seguente criterio:");
                ...
                expect(result).toContain("<p>10.2. In caso di parità perfetta, verrano sommati i premi previsti e divisi");
            });
        });
    });
}