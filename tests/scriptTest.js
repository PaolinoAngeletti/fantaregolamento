    ...
    describe("HTML ↔ JSON fields", function () {
        ...
        describe("from-HTML-to-JSON-tests", function () {
            ...
            let test_cases = [
                ...
                {field: "cbDifetto", value: false},
                {field: "cbDifetto", value: true},
                {field: "cbEccesso", value: false},
                {field: "cbEccesso", value: true},
        ...
        describe("from-JSON-to-HTML-tests", function () {
            ...
            let test_cases = [
                ...
                {field: "cbDifetto", start_value: false, final_value: true},
                {field: "cbDifetto", start_value: true, final_value: false},
                {field: "cbEccesso", start_value: false, final_value: true},
                {field: "cbEccesso", start_value: true, final_value: false},
